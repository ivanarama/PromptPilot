...
- Статус: **W3 stage planner implemented / Draft 0.4**
- Дата: 2026-08-25
...
- **W3 stage planner реализован:** отдельная роль planner, утверждаемый план,
  последовательные этапы со scope/gates/лимитами и автоматический переход после
  PASS независимого аудитора.
- **Остальная часть W3–W5 не завершена:** постоянный workflow-worktree, физически read-only
...
- сильный planner и машинный `stage-plan-v1`;
- ручное редактирование/утверждение последовательного плана;
- отдельный scope, deliverables, deterministic gates и revision limit этапа;
- автоматический переход к следующему этапу после независимого PASS;
- карточка workflow;
- timeline и findings;
